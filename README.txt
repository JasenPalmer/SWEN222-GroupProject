...
-	Choosing the name "admin" will give you a debug option in the top menu. 
	This allows the user to add items in inventory without needing to open chests and find them.
-	Viewing from the starting direction of the game (north), there is a gap in the bushes at the bottom of the map. 
	This leads to a maze which has lighting effects.
